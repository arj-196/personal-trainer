...
def test_plan_writes_comparison_files_for_multiple_models(
    ...
    assert ollama_plan_pdf.read_bytes().startswith(b"%PDF-1.4")
    assert openai_plan_pdf.read_bytes().startswith(b"%PDF-1.4")
